...
WORK_DIR=/work3/s203557/outputs_box_only/test_results_class_${CLASS_ARRAY[$ARRAY_INDEX]}

# Correct call to test.py
python segmentation/test.py segmentation/configs/vpd_config.py /work3/s203557/checkpoints/iter_2000_warmup.pth --class-filter ${CLASS_ARRAY[$ARRAY_INDEX]} --work-dir ${WORK_DIR} --eval mIoU --input-type box
