...
def register_attention_control(model, controller):
    """
    Given *either* a raw LatentDiffusion (with .model or .diffusion_model)
    *or* your MMseg DiffusionWrapper, find the inner UNet and register hooks.
    """
    # 1) figure out where the actual UNet lives
    ...
    #sub_nets = model.model.named_children()
...
def register_hier_output(model):
    ...
    def forward(x, timesteps=None, context=None, y=None,control = None,**kwargs):
        """
...
class UNetWrapper(nn.Module):
    ...
    def forward(self, x, timesteps=None, context=None, y=None, box_control=None, **kwargs):
        ...
        trainable_unet = self.trainable_unet.model
        frozen_unet   = self.unet.model
